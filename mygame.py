...
def create_character_skill_sheet():
	cls()
	global character_name, character_race, character_class, character_strength, character_dexeterity, character_magic, character_life
	print("""
	...
	"""
	Dexterity: """+str(character_dexeterity)+
	"""
...
def modify_skills():
	cls()
	global character_strength,character_dexeterity,character_life
	...
	roll=randint(1,6)
	print("You rolled: "+str(roll))
	character_dexeterity = character_dexeterity + roll
...
def skill_check():
	...
	roll=randint(1,6)
	print("You rolled: "+str(roll))
	if roll+character_dexeterity > 10:
		print ("""
